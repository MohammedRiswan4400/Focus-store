...
class DescriptionWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const Text(
      "Google Pixel 6 pro fly dummy text of the printing and type setting industry. Lorem Ipsum has been the industry's atlas standard dummy text ever since the 1500s when an unkno printer took a galley of type and scrambled it to make an a type specimen book. It has survived not only five centuries, but also the leap  into electronic typesetting, remaining a essentially unchanged. It was popularised inthe 1960s with the  release of Letraset sheets containing Lorem.",
      style: TextStyle(
        fontFamily: "Ubuntu",
        fontWeight: FontWeight.w500,
        fontSize: 12,
